...
describe("Flash Loans", function () {
    it("Should take a flash loan and be able to return it", async function () {
        ...
        await token
            .connect(signer)
            .transfer(flashLoanExample.getAddress(), BALANCE_AMOUNT_DAI); // Sends our contract 2000 DAI from the DAI_WHALE
